...
%
%  Usage : depuis la racine du recueil,  lecon.bat 101  (Windows) ou
%  ./lecon.sh 101  (Mac, Linux) ; « all » compile toutes les leçons de 100/ et
%  200/. Un double-clic sur lecon.bat (Windows) ou lecon.command (Mac) = all.
...
%  chemin (un développement par exemple) :  lecon.bat DevAlg/baseburnside
