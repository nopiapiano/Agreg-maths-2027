...
\Def
{
	Soit $x \in X$.
	\begin{itemize}
	    \item On appelle orbite de $x$, l'ensemble $\operatorname{Orb}(x) := \{\rho(g, x) \mid g \in G\}$
	    \item On appelle stabilisateur de $x$, l'ensemble $\operatorname{Stab}(x) := \{g \in G \mid \rho(g, x) = x\}$
	    \item On appelle fixateur de $g$, l'ensemble $ \operatorname{Fix}(g) := \{x \in X \mid \rho(g, x) = x\}$
	\end{itemize}
}
